...
export function SectionHeader({ title, subtitle, rightText }: { title: string; subtitle: string; rightText?: string }) {
...
export function CardTitle({ title, subtitle, icon, rightText }: { title: string; subtitle: string; icon?: ReactNode; rightText?: string }) {
...
export function KpiCard({ icon, iconBg, title, children }: { icon: ReactNode; iconBg: string; title: string; children: ReactNode }) {
