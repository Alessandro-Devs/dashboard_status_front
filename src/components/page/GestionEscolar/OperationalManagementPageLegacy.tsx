...
export default function OperationalManagementPageLegacy() {
    ...
    const formationByBlock = useMemo(() => sortDescendingByNumber((operationalData.formacion.grupos ?? []).map(normalizeFormationGroup), (item) => item.percentage), [operationalData.formacion.grupos]);
