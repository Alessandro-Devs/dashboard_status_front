...
export default function OperationalManagementPageLegacy() {
    ...
    const formationByBlock = useMemo(() => sortFormationByBlock((operationalData.formacion.grupos ?? []).map(normalizeFormationGroup)), [operationalData.formacion.grupos]);
