import { AlertTriangle, GraduationCap, School, Users, type LucideIcon } from "lucide-react";

const items: { icon: LucideIcon; iconColor: string; iconBg: string; title: string; value: string; valueColor: string; description: string }[] = [
