...
export default function SchoolNoAccessDashboard() {
  ...
  return <section className="bg-[#f7f9fc] px-4 py-8 text-[#14213d] sm:px-6"><div className="mx-auto max-w-[1200px]">
    <div className="mb-6"><p className="text-[11px] font-semibold uppercase tracking-[.12em] text-[#74849a]">Gestión Escolar</p><h1 className="mt-2 text-[24px] font-semibold text-[#20295e] sm:text-[28px]">Seguimiento de No Accesos</h1><p className="mt-1 text-[14px] text-[#8491a4]">Grupos 1, 2, 3, 4 y 5 · Viernes 7 al Martes 11</p></div>
