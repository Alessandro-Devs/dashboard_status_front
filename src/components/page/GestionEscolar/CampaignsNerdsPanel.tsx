...
import { CheckCircle2, Eye, MessageCircleQuestion, Reply, Send, XCircle } from "lucide-react";
...
const metrics = [
  ["Tipo de respuesta", "tipoRespuesta", MessageCircleQuestion, "text-[#176dcc]"],
  ["Mensajes no enviados", "mensajesNoEnviados", XCircle, "text-[#dc3d3d]"],
  ["Mensajes enviados", "mensajesEnviados", Send, "text-[#176dcc]"],
  ["Mensajes entregados", "mensajesEntregados", CheckCircle2, "text-[#168642]"],
  ["Leídos", "leidos", Eye, "text-[#7b3ff2]"],
  ["Respuestas recibidas", "respuestasRecibidas", Reply, "text-[#e77b13]"],
] as const;
