...
type LearningLine = { name: string; contenido: string; claseProducida: number | ""; items: LineItem[] };
...
const normalize = (value: unknown): LearningFormData => {
  ...
  return {
    ...
    lineasAplicativo: Array.isArray(source.lineasAplicativo) ? (source.lineasAplicativo as LearningLine[]).map((line) => ({ ...line, contenido: typeof line.contenido === "string" ? line.contenido : "", claseProducida: typeof line.claseProducida === "number" ? line.claseProducida : "" })) : clone(emptyTemplate.lineasAplicativo),
