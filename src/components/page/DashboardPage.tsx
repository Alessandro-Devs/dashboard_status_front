...
export default function DashboardPage({ view }: { view: string }) {
  ...
  if (visibleSection === "Gestión Escolar") return <SchoolManagementPage />;
  if (visibleSection === "Aprendizaje") return <LearningPage />;
  if (visibleSection === "Evaluación") return <EvaluationPage />;
  if (visibleSection === "Tutoría y Formación") return <TutoringAndTrainingPage />;
